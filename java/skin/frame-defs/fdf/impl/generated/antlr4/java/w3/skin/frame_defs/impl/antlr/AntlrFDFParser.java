...
public class AntlrFDFParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "AntlrFDF.g4"; }
	...
	public AntlrFDFParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class RootContext extends ParserRuleContext {
		public List<TerminalNode> WS() { return getTokens(AntlrFDFParser.WS); }
		public TerminalNode WS(int i) {
			return getToken(AntlrFDFParser.WS, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).enterRoot(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).exitRoot(this);
		}
	}
	...
	public static class StringListContext extends ParserRuleContext {
		public TerminalNode CURLY_L() { return getToken(AntlrFDFParser.CURLY_L, 0); }
		public StringListContentContext stringListContent() {
			return getRuleContext(StringListContentContext.class,0);
		}
		public TerminalNode CURLY_R() { return getToken(AntlrFDFParser.CURLY_R, 0); }
		public List<TerminalNode> WS() { return getTokens(AntlrFDFParser.WS); }
		public TerminalNode WS(int i) {
			return getToken(AntlrFDFParser.WS, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).enterStringList(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).exitStringList(this);
		}
	}
	...
	public static class StringListContentContext extends ParserRuleContext {
		...
		public List<TerminalNode> COMMA() { return getTokens(AntlrFDFParser.COMMA); }
		public TerminalNode COMMA(int i) {
			return getToken(AntlrFDFParser.COMMA, i);
		}
		public List<TerminalNode> WS() { return getTokens(AntlrFDFParser.WS); }
		public TerminalNode WS(int i) {
			return getToken(AntlrFDFParser.WS, i);
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).enterStringListContent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).exitStringListContent(this);
		}
	}
	...
	public static class StringAssignContext extends ParserRuleContext {
		public Token id;
		public Token val;
		public TerminalNode ID() { return getToken(AntlrFDFParser.ID, 0); }
		public TerminalNode STRING_LITERAL() { return getToken(AntlrFDFParser.STRING_LITERAL, 0); }
		public List<TerminalNode> WS() { return getTokens(AntlrFDFParser.WS); }
		public TerminalNode WS(int i) {
			return getToken(AntlrFDFParser.WS, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).enterStringAssign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AntlrFDFListener ) ((AntlrFDFListener)listener).exitStringAssign(this);
		}
	}
