...
public class W3DooUnits extends KaitaiStruct {
    ...
    public W3DooUnits(KaitaiStream _io, int useSkin) {
        this(_io, null, null, useSkin);
    }

    public W3DooUnits(KaitaiStream _io, KaitaiStruct _parent, int useSkin) {
        this(_io, _parent, null, useSkin);
    }

    public W3DooUnits(KaitaiStream _io, KaitaiStruct _parent, W3DooUnits _root, int useSkin) {
        super(_io);
    ...
    public static class CustomGroup extends KaitaiStruct {
        ...
        private void _read() {
            ...
            this.groupUnit = new ArrayList<GroupUnit>();
            for (int i = 0; i < numGroupUnit(); i++) {
                this.groupUnit.add(new GroupUnit(this._io, this, _root));
            }
        }
        private long numGroupUnit;
        private ArrayList<GroupUnit> groupUnit;
        private W3DooUnits _root;
        private W3DooUnits.Random _parent;
        public long numGroupUnit() { return numGroupUnit; }
        public ArrayList<GroupUnit> groupUnit() { return groupUnit; }
        public W3DooUnits _root() { return _root; }
        public W3DooUnits.Random _parent() { return _parent; }
    }
    public static class GroupUnit extends KaitaiStruct {
        ...
        public GroupUnit(KaitaiStream _io, W3DooUnits.CustomGroup _parent) {
            this(_io, _parent, null);
        }

        public GroupUnit(KaitaiStream _io, W3DooUnits.CustomGroup _parent, W3DooUnits _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private long chance;
        private W3DooUnits _root;
        private W3DooUnits.CustomGroup _parent;
        public W3id id() { return id; }
        public long chance() { return chance; }
        public W3DooUnits _root() { return _root; }
        public W3DooUnits.CustomGroup _parent() { return _parent; }
    }
    public static class Unit extends KaitaiStruct {
        ...
        public Unit(KaitaiStream _io, W3DooUnits _parent) {
            this(_io, _parent, null);
        }

        public Unit(KaitaiStream _io, W3DooUnits _parent, W3DooUnits _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        public W3DooUnits _root() { return _root; }
        public W3DooUnits _parent() { return _parent; }
    }
    ...
    public int useSkin() { return useSkin; }
    public W3DooUnits _root() { return _root; }
