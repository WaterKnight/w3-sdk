...
public class W3Doo extends KaitaiStruct {
    ...
    public W3Doo(KaitaiStream _io, int useSkin) {
        this(_io, null, null, useSkin);
    }

    public W3Doo(KaitaiStream _io, KaitaiStruct _parent, int useSkin) {
        this(_io, _parent, null, useSkin);
    }

    public W3Doo(KaitaiStream _io, KaitaiStruct _parent, W3Doo _root, int useSkin) {
        super(_io);
