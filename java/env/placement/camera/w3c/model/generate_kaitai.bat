...
curl -o ./w3-w3c.ksy https://raw.githubusercontent.com/WaterKnight/Warcraft3-Formats-KaitaiStruct/main/w3-w3c.ksy

kaitai-struct-compiler^
    "./w3-w3c.ksy"^
    -t java -d ./generator/generated/kaitai/java^
    --java-package w3.env.placement.camera.w3c.model.kaitai