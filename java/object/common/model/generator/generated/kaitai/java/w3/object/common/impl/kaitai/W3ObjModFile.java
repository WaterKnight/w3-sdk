...
package w3.object.common.impl.kaitai;
...
public class W3ObjModFile extends KaitaiStruct {
    ...
    public static class Mod extends KaitaiStruct {
        ...
        public Mod(KaitaiStream _io, W3ObjModFile.Obj _parent) {
            this(_io, _parent, null);
        }

        public Mod(KaitaiStream _io, W3ObjModFile.Obj _parent, W3ObjModFile _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
