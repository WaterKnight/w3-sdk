...
public class W3W3u extends KaitaiStruct {
    ...
    public static class ObjectsChunk extends KaitaiStruct {
        ...
        public ObjectsChunk(KaitaiStream _io, W3W3u _parent) {
            this(_io, _parent, null);
        }

        public ObjectsChunk(KaitaiStream _io, W3W3u _parent, W3W3u _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Obj extends KaitaiStruct {
        ...
        public Obj(KaitaiStream _io, W3W3u.ObjectsChunk _parent) {
            this(_io, _parent, null);
        }

        public Obj(KaitaiStream _io, W3W3u.ObjectsChunk _parent, W3W3u _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3u _root;
        private W3W3u.ObjectsChunk _parent;
        ...
        public W3W3u _root() { return _root; }
        public W3W3u.ObjectsChunk _parent() { return _parent; }
    }
    public static class Mod extends KaitaiStruct {
        ...
        public Mod(KaitaiStream _io, W3W3u.Obj _parent) {
            this(_io, _parent, null);
        }

        public Mod(KaitaiStream _io, W3W3u.Obj _parent, W3W3u _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            ...
            this.varType = W3W3u.VarTypes.byId(this._io.readU4le());
        ...
        public W3W3u _root() { return _root; }
        public W3W3u.Obj _parent() { return _parent; }
    }
