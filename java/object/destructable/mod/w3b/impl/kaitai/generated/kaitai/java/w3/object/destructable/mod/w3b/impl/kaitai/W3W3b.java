...
package w3.object.destructable.mod.w3b.impl.kaitai;
...
public class W3W3b extends KaitaiStruct {
    ...
    public static class ObjectsChunk extends KaitaiStruct {
        ...
        public ObjectsChunk(KaitaiStream _io, W3W3b _parent) {
            this(_io, _parent, null);
        }

        public ObjectsChunk(KaitaiStream _io, W3W3b _parent, W3W3b _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Obj extends KaitaiStruct {
        ...
        public Obj(KaitaiStream _io, W3W3b.ObjectsChunk _parent) {
            this(_io, _parent, null);
        }

        public Obj(KaitaiStream _io, W3W3b.ObjectsChunk _parent, W3W3b _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3b _root;
        private W3W3b.ObjectsChunk _parent;
        ...
        public W3W3b _root() { return _root; }
        public W3W3b.ObjectsChunk _parent() { return _parent; }
    }
    public static class Mod extends KaitaiStruct {
        ...
        public Mod(KaitaiStream _io, W3W3b.Obj _parent) {
            this(_io, _parent, null);
        }

        public Mod(KaitaiStream _io, W3W3b.Obj _parent, W3W3b _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            ...
            this.varType = W3W3b.VarTypes.byId(this._io.readU4le());
            {
                VarTypes on = varType();
                if (on != null) {
                    switch (varType()) {
