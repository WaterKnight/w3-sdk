...
package w3.object.item.mod.w3t.impl.kaitai;
...
public class W3W3t extends KaitaiStruct {
    public static W3W3t fromFile(String fileName) throws IOException {
        return new W3W3t(new ByteBufferKaitaiStream(fileName));
    }
    ...
    public W3W3t(KaitaiStream _io) {
        this(_io, null, null);
    }

    public W3W3t(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public W3W3t(KaitaiStream _io, KaitaiStruct _parent, W3W3t _root) {
        super(_io);
    ...
    public static class ObjectsChunk extends KaitaiStruct {
        ...
        public ObjectsChunk(KaitaiStream _io, W3W3t _parent) {
            this(_io, _parent, null);
        }

        public ObjectsChunk(KaitaiStream _io, W3W3t _parent, W3W3t _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3t _root;
        private W3W3t _parent;
        public long numObj() { return numObj; }
        public ArrayList<Obj> obj() { return obj; }
        public W3W3t _root() { return _root; }
        public W3W3t _parent() { return _parent; }
    }
    public static class Obj extends KaitaiStruct {
        ...
        public Obj(KaitaiStream _io, W3W3t.ObjectsChunk _parent) {
            this(_io, _parent, null);
        }

        public Obj(KaitaiStream _io, W3W3t.ObjectsChunk _parent, W3W3t _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3t _root;
        private W3W3t.ObjectsChunk _parent;
        ...
        public W3W3t _root() { return _root; }
        public W3W3t.ObjectsChunk _parent() { return _parent; }
    }
    public static class Mod extends KaitaiStruct {
        ...
        public Mod(KaitaiStream _io, W3W3t.Obj _parent) {
            this(_io, _parent, null);
        }

        public Mod(KaitaiStream _io, W3W3t.Obj _parent, W3W3t _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            ...
            this.varType = W3W3t.VarTypes.byId(this._io.readU4le());
        ...
        public W3W3t _root() { return _root; }
        public W3W3t.Obj _parent() { return _parent; }
    }
