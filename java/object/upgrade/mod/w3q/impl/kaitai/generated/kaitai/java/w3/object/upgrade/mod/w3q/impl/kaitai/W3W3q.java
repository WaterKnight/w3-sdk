...
public class W3W3q extends KaitaiStruct {
    ...
    public static class ObjectsChunk extends KaitaiStruct {
        ...
        public ObjectsChunk(KaitaiStream _io, W3W3q _parent) {
            this(_io, _parent, null);
        }

        public ObjectsChunk(KaitaiStream _io, W3W3q _parent, W3W3q _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Obj extends KaitaiStruct {
        ...
        public Obj(KaitaiStream _io, W3W3q.ObjectsChunk _parent) {
            this(_io, _parent, null);
        }

        public Obj(KaitaiStream _io, W3W3q.ObjectsChunk _parent, W3W3q _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3q _root;
        private W3W3q.ObjectsChunk _parent;
        ...
        public W3W3q _root() { return _root; }
        public W3W3q.ObjectsChunk _parent() { return _parent; }
    }
    public static class Mod extends KaitaiStruct {
        ...
        public Mod(KaitaiStream _io, W3W3q.Obj _parent) {
            this(_io, _parent, null);
        }

        public Mod(KaitaiStream _io, W3W3q.Obj _parent, W3W3q _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            ...
            this.varType = W3W3q.VarTypes.byId(this._io.readU4le());
        ...
        public W3W3q _root() { return _root; }
        public W3W3q.Obj _parent() { return _parent; }
    }
