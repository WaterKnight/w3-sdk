...
public class W3W3h extends KaitaiStruct {
    public static W3W3h fromFile(String fileName) throws IOException {
        return new W3W3h(new ByteBufferKaitaiStream(fileName));
    }
    ...
    public W3W3h(KaitaiStream _io) {
        this(_io, null, null);
    }

    public W3W3h(KaitaiStream _io, KaitaiStruct _parent) {
        this(_io, _parent, null);
    }

    public W3W3h(KaitaiStream _io, KaitaiStruct _parent, W3W3h _root) {
        super(_io);
    ...
    public static class ObjectsChunk extends KaitaiStruct {
        ...
        public ObjectsChunk(KaitaiStream _io, W3W3h _parent) {
            this(_io, _parent, null);
        }

        public ObjectsChunk(KaitaiStream _io, W3W3h _parent, W3W3h _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3h _root;
        private W3W3h _parent;
        public long numObj() { return numObj; }
        public ArrayList<Obj> obj() { return obj; }
        public W3W3h _root() { return _root; }
        public W3W3h _parent() { return _parent; }
    }
    public static class Obj extends KaitaiStruct {
        ...
        public Obj(KaitaiStream _io, W3W3h.ObjectsChunk _parent) {
            this(_io, _parent, null);
        }

        public Obj(KaitaiStream _io, W3W3h.ObjectsChunk _parent, W3W3h _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3h _root;
        private W3W3h.ObjectsChunk _parent;
        ...
        public W3W3h _root() { return _root; }
        public W3W3h.ObjectsChunk _parent() { return _parent; }
    }
    public static class Mod extends KaitaiStruct {
        ...
        public Mod(KaitaiStream _io, W3W3h.Obj _parent) {
            this(_io, _parent, null);
        }

        public Mod(KaitaiStream _io, W3W3h.Obj _parent, W3W3h _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            ...
            this.varType = W3W3h.VarTypes.byId(this._io.readU4le());
        ...
        public W3W3h _root() { return _root; }
        public W3W3h.Obj _parent() { return _parent; }
    }
