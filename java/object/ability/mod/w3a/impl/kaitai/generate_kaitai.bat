...
REM curl -o ./w3-w3a.ksy https://raw.githubusercontent.com/WaterKnight/Warcraft3-Formats-KaitaiStruct/main/w3-w3a.ksy

kaitai-struct-compiler^
    "./w3-w3a.ksy"^
    -t java -d ./generated/kaitai/java^
    --java-package w3.object.ability.mod.w3a.impl.kaitai