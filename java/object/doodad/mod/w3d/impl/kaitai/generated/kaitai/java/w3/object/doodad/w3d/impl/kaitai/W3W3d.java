...
package w3.object.doodad.w3d.impl.kaitai;
...
public class W3W3d extends KaitaiStruct {
    ...
    public static class ObjectsChunk extends KaitaiStruct {
        ...
        public ObjectsChunk(KaitaiStream _io, W3W3d _parent) {
            this(_io, _parent, null);
        }

        public ObjectsChunk(KaitaiStream _io, W3W3d _parent, W3W3d _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
    ...
    public static class Obj extends KaitaiStruct {
        ...
        public Obj(KaitaiStream _io, W3W3d.ObjectsChunk _parent) {
            this(_io, _parent, null);
        }

        public Obj(KaitaiStream _io, W3W3d.ObjectsChunk _parent, W3W3d _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3d _root;
        private W3W3d.ObjectsChunk _parent;
        ...
        public W3W3d _root() { return _root; }
        public W3W3d.ObjectsChunk _parent() { return _parent; }
    }
    public static class Mod extends KaitaiStruct {
        ...
        public Mod(KaitaiStream _io, W3W3d.Obj _parent) {
            this(_io, _parent, null);
        }

        public Mod(KaitaiStream _io, W3W3d.Obj _parent, W3W3d _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private void _read() {
            ...
            this.varType = W3W3d.VarTypes.byId(this._io.readU4le());
        ...
        public W3W3d _root() { return _root; }
        public W3W3d.Obj _parent() { return _parent; }
    }
