...
REM curl -o ./w3-w3d.ksy https://raw.githubusercontent.com/WaterKnight/Warcraft3-Formats-KaitaiStruct/main/w3-w3d.ksy

kaitai-struct-compiler^
    "./w3-w3d.ksy"^
    -t java -d ./generated/kaitai/java^
    --java-package w3.object.doodad.mod.w3d.impl.kaitai