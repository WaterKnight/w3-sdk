...
package w3.info.w3i.model.kaitai;
...
public class W3W3i extends KaitaiStruct {
    ...
    public enum RandomUnitTableColumnType {
        ...
        private final long id;
        RandomUnitTableColumnType(long id) { this.id = id; }
        public long id() { return id; }
        private static final Map<Long, RandomUnitTableColumnType> byId = new HashMap<Long, RandomUnitTableColumnType>(3);
        static {
            for (RandomUnitTableColumnType e : RandomUnitTableColumnType.values())
                byId.put(e.id(), e);
        }
        public static RandomUnitTableColumnType byId(long id) { return byId.get(id); }
    }
    ...
    public static class PlayerBitmap extends KaitaiStruct {
        ...
        private void _read() {
            ...
            KaitaiStream _io__raw_bits = new ByteBufferKaitaiStream(_raw_bits);
            this.bits = new PlayerBitmapBits(_io__raw_bits, this, _root);
        }
        private PlayerBitmapBits bits;
        private W3W3i _root;
        private KaitaiStruct _parent;
        private byte[] _raw_bits;
        public PlayerBitmapBits bits() { return bits; }
        public W3W3i _root() { return _root; }
        public KaitaiStruct _parent() { return _parent; }
        public byte[] _raw_bits() { return _raw_bits; }
    }
    ...
    public static class RandomUnitTable extends KaitaiStruct {
        ...
        private void _read() {
            ...
            this.columnType = new ArrayList<RandomUnitTableColumnType>();
            for (int i = 0; i < numColumnType(); i++) {
                this.columnType.add(W3W3i.RandomUnitTableColumnType.byId(this._io.readU4le()));
            }
        ...
        private ArrayList<RandomUnitTableColumnType> columnType;
        private long numRow;
        ...
        public ArrayList<RandomUnitTableColumnType> columnType() { return columnType; }
    ...
    public static class ForceFlagsBits extends KaitaiStruct {
        public static ForceFlagsBits fromFile(String fileName) throws IOException {
            return new ForceFlagsBits(new ByteBufferKaitaiStream(fileName));
        }

        public ForceFlagsBits(KaitaiStream _io) {
            this(_io, null, null);
        }

        public ForceFlagsBits(KaitaiStream _io, W3W3i.ForceFlags _parent) {
            this(_io, _parent, null);
        }

        public ForceFlagsBits(KaitaiStream _io, W3W3i.ForceFlags _parent, W3W3i _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3i _root;
        private W3W3i.ForceFlags _parent;
        ...
        public W3W3i _root() { return _root; }
        public W3W3i.ForceFlags _parent() { return _parent; }
    }
    ...
    public static class RandomUnitTableRow extends KaitaiStruct {
        ...
        private void _read() {
            ...
            this.id = new ArrayList<W3id>();
            for (int i = 0; i < _parent().numColumnType(); i++) {
                this.id.add(new W3id(this._io));
            }
        }
        private long chance;
        private ArrayList<W3id> id;
        private W3W3i _root;
        private W3W3i.RandomUnitTable _parent;
        public long chance() { return chance; }
        public ArrayList<W3id> id() { return id; }
        public W3W3i _root() { return _root; }
    ...
    public static class PrologueScreen extends KaitaiStruct {
        ...
        private void _read() {
            if ( ((_root().version() != 18) && (_root().version() != 19)) ) {
    ...
    public static class ForceFlags extends KaitaiStruct {
        ...
        private void _read() {
            this._raw_bits = this._io.readBytes(4);
            KaitaiStream _io__raw_bits = new ByteBufferKaitaiStream(_raw_bits);
            this.bits = new ForceFlagsBits(_io__raw_bits, this, _root);
        }
        private ForceFlagsBits bits;
        private W3W3i _root;
        private W3W3i.Force _parent;
        private byte[] _raw_bits;
        public ForceFlagsBits bits() { return bits; }
        public W3W3i _root() { return _root; }
    ...
    public static class PlayerBitmapBits extends KaitaiStruct {
        public static PlayerBitmapBits fromFile(String fileName) throws IOException {
            return new PlayerBitmapBits(new ByteBufferKaitaiStream(fileName));
        }

        public PlayerBitmapBits(KaitaiStream _io) {
            this(_io, null, null);
        }

        public PlayerBitmapBits(KaitaiStream _io, W3W3i.PlayerBitmap _parent) {
            this(_io, _parent, null);
        }

        public PlayerBitmapBits(KaitaiStream _io, W3W3i.PlayerBitmap _parent, W3W3i _root) {
            super(_io);
            this._parent = _parent;
            this._root = _root;
            _read();
        ...
        private W3W3i _root;
        private W3W3i.PlayerBitmap _parent;
        public ArrayList<Boolean> isMember() { return isMember; }
        public W3W3i _root() { return _root; }
        public W3W3i.PlayerBitmap _parent() { return _parent; }
    }
